# data augmentation;Modelin daha fazla ve daha çeşitli görüntü görmesini sağlayarak overfitting'i azaltmak.

# dönüşümden sonra görüntü hala aynı sınıfa mı ait? sorusunu sorarız, eğer hayrısa kullanma, farklı bir anlam çıkabilir dönüşümden
...
# oluşturduğun ilk artırılmış görüntüyü bana ver 
augmented = next(iterator)[0]

# squeeze; görüntü 28*28*1 ama matplotlib 28*28 istiyor. sondaki 1 kanalını kaldırıyor  
